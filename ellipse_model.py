...
class CentroidConditionedEllipseNet(nn.Module):
    def __init__(self, in_channels: int = 2, base_channels: int = 32, hidden_dim: int = 128) -> None:
        super().__init__()
...
__all__ = ["CentroidConditionedEllipseNet"]
