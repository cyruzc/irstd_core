...
class RadialProfileEllipseNet(nn.Module):
    def __init__(
        self,
        in_channels: int = 2,
        base_channels: int = 32,
        hidden_dim: int = 128,
        num_profile_samples: int = 36,
    ) -> None:
        super().__init__()
        self.num_profile_samples = int(num_profile_samples)
        out_dim = 6 + self.num_profile_samples
...
__all__ = ["RadialProfileEllipseNet"]
